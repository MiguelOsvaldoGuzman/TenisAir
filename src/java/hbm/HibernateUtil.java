...
public class HibernateUtil {
    ...
    /**
     * este bloque de codigo de tipo static es una especie de constructor pero solo para atributos de tipo static
     * la principal diferencia con un constructor es que el constructor se ejecuta cuando creas el objeto esto 
     * quiere decir que se puede ejecutar mas de una vez durante la ejecucion del programa.
     * sin embargo el bloque static solo se ejecuta una sola vez sin importar la cantidad de objetos que sean creados
     * es comunmente utilizado para inicializar atributos de tipo static final ya el valor de estos atributos son 
     * compartidos por todos los objetos creados y su valor no puede cambiar durante toda la ejecucion del programa
     */
    static {
